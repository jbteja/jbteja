...
After a decade of learning, I understood that the technology itself doesn't matter as long as there is proper documentation or a proper handoff from the previous owner, along with some time to get a kickstart -> that's all needed to do anything new from scratch.
